...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    // Will contain the actual code, positioned to core the viewport.
    ...
    // Moved around its parent to core visible view.
  ...
  // Force the view to core a given range, adding empty view element
  ...
  function onScrollWheel(cm, e) {
    ...
    // 'Project' the visible viewport to core the area that is being
  ...
  // core the line in which the change took place. Removes spans
  ...
  // comparing ids when the spans core exactly the same range.
